...
if( isset( $_POST['login'] ) ) {
    ...
    // cate SQL query
    $query = "SELECT username, email, password FROM businessUser WHERE username='$username'";
    ...
    // cate SQL query
    $query = "SELECT username, email, password FROM problemsetter WHERE username='$username'";
    ...
    if( mysqli_num_rows($result) > 0 ) {
        ...
        // verify hashed password with the typed password
        if( strcmp($password,$hashedPass) == 0 ) {
...
if( isset( $_POST['businessSignup'] ) ) {
    ...
    $username = validateFormData( $_POST['signup-username'] );
    $company = validateFormData( $_POST['signup-company'] );
    $email = validateFormData( $_POST['signup-email'] );
    $password = password_hash (validateFormData( $_POST['signup-password'] ), PASSWORD_DEFAULT);
    
        $query = "INSERT INTO businessuser (username, password, email, signupdate, company)
        VALUES ('$username', '$password', '$email', CURRENT_TIMESTAMP, '$company')";
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" id="formEmail" placeholder="First Name" name="" required>
                            </div>
                        </div>
                          ...
                          <input type="text" class="form-control" id="formEmail" placeholder="Last Name" name="" required>
                            </div>
                        </div>
...
<form class="modal fade" action="<?php echo htmlspecialchars( $_SERVER['PHP_SELF'] ); ?>" method="post" id="BusinessSignupModal">
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        <h1 class="modal-title"> Hello, Sir! </h1>
                        <button type="button" class="close" data-dismiss="modal"><span>&times;</span></button>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" id="" placeholder="Company Name" name="signup-company" required>
                            </div>
                            <div class="input-group mb-3">
                         
                          <input type="text" class="form-control" id="" placeholder="First Name" name="signup-firstname" required>
                            </div>
                        </div>
                          ...
                          <input type="text" class="form-control" id="" placeholder="Last Name" name="signup-lastname" required>
                            </div>
                        </div>
                        ...
                        <button type="submit" for="Signup_submit" class="btn btn-primary btn-lg btn-block" name="businessSignup">Sign Up</button>
